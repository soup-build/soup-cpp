...
class MSVCArgumentBuilderUnitTests {
	...
	RunTests() {
		System.print("MSVCArgumentBuilderUnitTests.BSDA_SingleArgument_LanguageStandard(LanguageStandard.CPP11, \"-std=c++11\")")
		this.BSDA_SingleArgument_LanguageStandard(LanguageStandard.CPP11, "/std:c++11")
		System.print("MSVCArgumentBuilderUnitTests.BSDA_SingleArgument_LanguageStandard(LanguageStandard.CPP14, \"-std=c++14\")")
