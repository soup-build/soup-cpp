// <copyright file="gcc-argument-builder-unit-tests.wren" company="Soup">
...
class GCCArgumentBuilderUnitTests {
	...
	RunTests() {
		...
		System.print("GCCArgumentBuilderUnitTests.BSCA_SingleArgument_LanguageStandard(LanguageStandard.CPP17, \"-std=c++17\")")
		...
		System.print("GCCArgumentBuilderUnitTests.BSCA_SingleArgument_OptimizationLevel(OptimizationLevel.Size, \"-Os\")")
		this.BSCA_SingleArgument_OptimizationLevel(OptimizationLevel.Size, "-Os")
		System.print("GCCArgumentBuilderUnitTests.BSCA_SingleArgument_OptimizationLevel(OptimizationLevel.Speed, \"-O3\")")
