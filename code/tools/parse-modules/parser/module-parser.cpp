...
public:
    ...
    bool TryParse()
    {
        ...
        {
            _imports.push_back(SMLValue(importName));
        }
    ...
    SMLDocument GetResult()
    {
      ...
      result.Insert("IsModule", SMLValue(_isModule));
      if (_isModule)
      {
          result.Insert("IsInterface", SMLValue(_isInterface));
          result.Insert("Name", SMLValue(_moduleName));
      }

      result.Insert("Imports", SMLValue(SMLArray(_imports)));
